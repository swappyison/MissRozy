...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 23869063))
	API_HASH = os.environ.get("API_HASH", "c529c9a0ce99a731997d71af082a9f12")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","5829107150:AAH-zrb3HFadNT6NIhKZSLbiDHzb7HGiEOk")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "nayatorrentbot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002051427055))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6171560830"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://swapnilupadhyaykratos:V9eFyv3M9Bd1rXkf@cluster0.wsrqmd7.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002051427055")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002051427055")
